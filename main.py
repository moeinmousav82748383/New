...
برای سفارش بگو مثلا: ماینز طلایی ماهانه""",
        
        "✅ لیست قیمت‌ها ارسال شد. کدوم پکیج مدنظرت هست؟"
    ],
    
    "percent": [
        "✅ بازی درصدی فعال است.\nحداقل واریز: ۵۰۰ هزار تومان\nما به جات بازی میکنیم (حداقل ۱۰ برابر) و ۷۰ درصد سود مال توست.\nمبلغ واریزی رو بگو.",
        "🎯 بازی درصدی:\nاز ۵۰۰ هزار تومان شروع کن. ۷۰٪ سود به حسابت برمی‌گرده."
    ],
    ...
    "thank": ["خواهش میکنم! ❤️", "ممنون از تو!", "خوشحالیم که تونستیم کمک کنیم."],
...
if __name__ == "__main__":
    asyncio.run(main())• ماهانه: ۱,۵۰۰,۰۰۰ تومان
